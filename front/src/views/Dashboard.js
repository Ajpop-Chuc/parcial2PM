    ...
    <>
      <Container fluid>
        <Row>
          <Col lg="3" sm="6">
            <Card style={{
              boxShadow: '0px 1px 3px 1px gray', /* Sombra ligera */
            }}
          ...
          <Col lg="3" sm="6">
            <Card style={{
              backgroundImage: 'linear-gradient(270deg, #77dd77, #FFFFFF)', 
              boxShadow: '0px 1px 3px 1px gray', /* Sombra ligera */
            }}
            className="card-stats">
              <Card.Body>
          ...
          <Col lg="3" sm="6">
            <Card style={{
              backgroundImage: 'linear-gradient(270deg, #80CEE1, #FFFFFF)', /* Degradado */
              boxShadow: '0px 1px 3px 1px gray', /* Sombra ligera */
            }}
            className="card-stats">
              <Card.Body>
